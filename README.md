...
- `-v, --verbose` или `VERBOSE` — debug логирование
...
```bash
# Map-reduce режим
INFO map-reduce pipeline started  chunk_length=10000 concurrency=4
...
./ragcli map --file large_document.txt "Суммируй ключевые выводы"
