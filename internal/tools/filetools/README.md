...
Пакет даёт локальные инструменты для исследования файла или директории: список файлов, поиск, чтение диапазона строк и чтение окна вокруг строки. Он используется в `tools`.
